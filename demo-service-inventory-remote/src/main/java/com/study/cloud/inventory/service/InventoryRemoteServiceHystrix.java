 ...
 */
@Component
class InventoryRemoteServiceHystrix implements InventoryRemoteService {
	private static final Logger log = LoggerFactory.getLogger(InventoryRemoteServiceHystrix.class);
